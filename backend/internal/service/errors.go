...
var (
	...
	ErrReviewPending     = errors.New("the finalized decision is waiting for a re-review")
	ErrNotPendingReview  = errors.New("only decisions flagged review_pending can be re-reviewed")
)
